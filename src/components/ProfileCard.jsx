    ...
    return (
        <div className='h-full'>
            <div className='flex flex-col justify-between h-full max-w-3/4'>
                <div>
                    <p>Hi, I'm Antonio Pavin, a full-stack developer (frontend-leaning) with a good eye for design.</p>
                    <p>I've worked Freelance and still in progress of learning all that i desire </p>
